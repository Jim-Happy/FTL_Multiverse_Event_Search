...
如果你不想自己配置 Python 环境，可以直接前往 [GitHub Releases](https://github.com/Jim-Happy/FTL_Multiverse_Event_Search/releases/tag/v0.1.0) 下载已经打包好的版本。发布页中提供的压缩包文件名为 `FTLSearch.rar`，适合直接解压后运行，程序是单文件版本。
